...
const TeamMember = ({ name, title, description, image }) => (
  <div className="group flex flex-col justify-center items-center">
    <div className="relative rounded-lg overflow-hidden transition-transform duration-500 group-hover:scale-105" style={{ maxWidth: '80%' }}>
      <img
        src={image}
        alt={`Team Member ${name}`}
        className="w-full h-70 sm:h-86 object-cover object-fit:cover transition-transform duration-500 group-hover:rotate-1 group-hover:scale-125"
      />
